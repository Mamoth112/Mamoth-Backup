  ...
  run(message, args) {
    ...
    if (
      ...
      embed // Build help embed
        ...
        .setTimestamp()
        .setImage('https://cdn.discordapp.com/attachments/762229292121587716/816625929962389544/mamoth112png.png')
        .setColor(message.guild.me.displayHexColor);
      ...
      embed.addField(
        '**Links**', 
        '[Support Server](https://discord.gg/mYHE3uw) '
      );
