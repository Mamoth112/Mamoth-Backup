module.exports = async (client) => {
  ...
  for (const guild of leftGuilds) {
    ...
    client.logger.info(`MamothBot has left ${guild.guild_name}`);
  }

  client.logger.info('MamothBot is now online');
  client.logger.info(`MamothBot is running on ${client.guilds.cache.size} server(s)`);
};
